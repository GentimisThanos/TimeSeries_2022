...
##b) ACF
```{r}
dgoog %>% ACF(diff, lag_max = 12) #monthly?
...
This tsibble contains 64 separate time series corresponding to the combinations of the 8 states, 2 genders, 2 legal statuses and 2 indigenous statuses. Each of these series is 48 observations in length, from 2005 Q1 to 2016 Q4. #I dont understand how they come up with this numbers.

Is the autoplot created based on ggplot2?

I don't get difference between cyclic and seasonal. 2.3
